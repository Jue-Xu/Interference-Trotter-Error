...
from eig_overlap import neighbor_heisenberg, eig_overlap
...
def approx_interf_bound(H_list, H_list2, n, t, r):
    overlap_ratio = eig_overlap(neighbor_heisenberg(n))
    print(overlap_ratio)
    int_bound = interference_bound(H_list2, t, r)[0]
    tri_bound = triangle_bound(H_list, 1, t, r)
    approx_bound = overlap_ratio * np.array(tri_bound) + (1-overlap_ratio) * np.array(int_bound)
    return approx_bound
